...
function NewsletterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setSuccess("");
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "https://crappylife-backend.onrender.com")}/api/newsletter/subscribers/`, {
                method: "POST",
                headers: {
...
//# sourceMappingURL=_a7d5b8f1._.js.map