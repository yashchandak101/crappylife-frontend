...
;
/**
 * Safely resolve image URLs coming from backend or Cloudinary.
 */ function getImageUrl(path) {
    if (!path) return "/fallback-image.png"; // ✅ Fallback image
    // Already a full URL (Cloudinary, S3, etc.)
    if (path.startsWith("http")) return path;
    // Cloudinary shorthand like "image/upload/articles/30gold.webp"
    if (path.startsWith("image/")) {
        return `https://res.cloudinary.com/dvksqgurb/${path}`;
    }
    // Handle backend-served paths like "/media/articles/..."
    const baseUrl = ("TURBOPACK compile-time value", "https://crappylife-backend.onrender.com")?.replace(/\/$/, "") || "";
    const cleanPath = path.startsWith("/") ? path : `/${path}`;
    return `${baseUrl}${cleanPath}`;
}
function FeaturedCarousel() {
    const [articles, setArticles] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"]([]);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        async function fetchFeatured() {
            try {
                const res = await fetch(`${("TURBOPACK compile-time value", "https://crappylife-backend.onrender.com")}/api/events/events/`);
...
//# sourceMappingURL=src_25bef70b._.js.map